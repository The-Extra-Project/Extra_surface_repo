...
public :
    ...
    int parse(int argc, char **argv)
    {
        ...
        while ((cc = getopt_long(argc, argv, "s:a:n:u:t:l:b:z:j:p:k:y:r:w:m:x:giecfh",long_options,&option_index)) != -1)
        {
            switch (cc)
            {
            case 's':
