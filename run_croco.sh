...
./build//build-spark-Release-3/bin/wasure-local-exe --output_dir /home/laurent/shared_spark/tests_outputs/run_3d_croco/ --input_dir ./datas/3d_bench_small --dim 3 --bbox 0000x10000:0000x10000  --pscale 0.05 --nb_samples 10 --mode surface --lambda 1 --step full_stack --seed 18696 --label full_stack_croco --filename ./datas/3d_bench_small/croco_small.ply
