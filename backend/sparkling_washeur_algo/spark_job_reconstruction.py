...
if __name__ == "__main__":
    spark_session = SparkSession.builder.appName("Spark_extrasurface").config("spark.jars", "./build/spark/target/scala-2.13/iqlib-spark_2.13-1.0.jar").config("master",f"http://${MASTER_IP}:7077") \
