...
object WorkflowWasure {
  def main(args: Array[String]): Unit = 
  {
    ...
    if (params.contains("INPUT_DATA_DIR") && params.contains("OUTPUT_DATA_DIR") && params.contains("PARAM_PATH") && params.contains("DDT_MAIN_DIR") && params.contains("GLOBAL_BUILD_DIR")) {
      val input_dir = params("INPUT_DATA_DIR").replaceAll("//", "/");
    ...
    if (output_dir.isEmpty || input_dir.isEmpty )
    {
      ...
      System.err.println("Input/Output Dir Bash variables is/are empty")
